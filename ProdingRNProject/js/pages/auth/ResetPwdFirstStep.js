...
const mapDispatchToProps = dispatch => ({
    ...
    getVerificationCode: (mobile, captchaText, captchaHash, purpose, type) => dispatch(fetchMobileVerificationCodeAction({mobile, captchaText, captchaHash, purpose, type})),
