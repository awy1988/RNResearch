...
import { COMMON_PAGE_TITLE_HEIGHT, DEVICE_WIDTH } from '../../constants/StyleConstants';
...
export default class ItemDetailMainSubPage extends Component {
  // 构造
  constructor(props) {
    super(props);
    // 初始状态
  ...
  _handlePanResponderMove(event: Object, gestureState: Object): void {
    ...
    const nowLeft = gestureState.dy * 0.5;
...
height: CONTENT_HEIGHT,
          ...
          <View style={{ width: DEVICE_WIDTH, height: 100, backgroundColor: 'white', alignItems: 'center', justifyContent: 'center' }}>
            <Text>上拉查看详情</Text>
          </View>
        </Animated.View>
...
justifyContent: 'center',
          ...
          <View
            style={{ width: DEVICE_WIDTH, height: CONTENT_HEIGHT }}
          >
            <ScrollView
...
const styles = StyleSheet.create({
  container: {
    ...
    width: '100%',
    // transform:[{translateY:-CONTENT_HEIGHT}]
  },
  container1: {
    width: DEVICE_WIDTH,
    height: CONTENT_HEIGHT,
