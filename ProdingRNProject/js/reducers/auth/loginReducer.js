...
export default login = (state = initialState, action) => {
  switch (action.type) {
    case types.login.REQUEST_USER_LOGIN:
    ...
    case types.login.REQUEST_USER_LOGIN_SUCCESS:
      return {
        ...state,
        isLoading: false,
        isLoginSuccess: true,
      };
    case types.login.REQUEST_USER_LOGIN_FAILED:
      return {
        ...state,
        isLoading: false,
        isLoginSuccess: false,
    ...
    case types.login.USER_LOGIN_SHOW_CAPTCHA:
      return {
        ...state,
        isNeedCaptcha: true,
    ...
    case types.login.USER_LOGIN_EXIT:
      return initialState;
  }
  return state;
};
